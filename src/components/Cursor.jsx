...
export const Cursor = () => {
  ...
  return (
    <>
      <div
        className={` md:visible  z-50 fixed -translate-x-1/2 -translate-y-1/2 rounded-full pointer-events-none transition-transform
        ${hoverButton ? 'bg-transparent border-2 border-white w-5 h-5' : 'bg-white-500 w-3 h-3'}`}
        ref={cursorOutline}
      ></div>
    </>
  );
